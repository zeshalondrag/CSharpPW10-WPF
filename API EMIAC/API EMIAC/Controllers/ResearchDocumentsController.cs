...
namespace API_EMIAC.Controllers
{
    ...
    public class ResearchDocumentsController : ControllerBase
    {
        ...
        public ResearchDocumentsController(EmiacContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<ResearchDocument>>> GetResearchDocument()
        {
            return await _context.ResearchDocument.ToListAsync();
        }
        ...
        {
            var researchDocument = await _context.ResearchDocument.FindAsync(id);
        ...
        {
            _context.ResearchDocument.Add(researchDocument);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteResearchDocument(int? id)
        {
            ...
            _context.ResearchDocument.Remove(researchDocument);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.ResearchDocument.Any(e => e.IdResearchDocument == id);
        }
    }
}
